...
%>
<%String cgID = (String)request.getAttribute("cgID") ;%>
<%
	String searchText = session.getAttribute("searchProductText") != null
			? (String) session.getAttribute("searchProductText"): "";
	 String functionPrefix = "".equals(searchText) ? "ShowProductByCatGroup?catGroupID=" + cgID +"&": "SearchProductServlet"; 
	%>
...
<body>
    <header>
        ...
        <form method="POST" action="SearchProductServlet" class="header-center">
            <nav>
                <ul>
            ...
            <div class="search-bar">
                <input type="text" class="search-input"  value="<%=searchText%>"  name="searchText" placeholder="Tìm kiếm...">
    ...
    <div class="sub-header">
        <div class="breadcrumb">
            <a href="#">Trang chủ</a> / <a >Sản phẩm</a> <span></span> 
        </div>
        <div class="filter">
            <select>
            ...
            <div>
               ...
               <%for(CategoryGroup cg : catGroupList) {%>
                <div class="category">
                    ...
                    <div class="expand" onclick="toggleSubcategory(this)"></div>
                    <div class="subcategory">
                        <div class="category-name-sub"><a href="#">Sữa rửa mặt</a></div>
                        <div class="category-name-sub"><a href="#">Serum</a></div>
                        <div class="category-name-sub"><a href="#">Dưỡng ẩm da mặt</a></div>
                    </div>
                </div>
                <%} %>
